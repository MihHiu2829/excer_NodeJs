...
function initModels(sequelize) {
  ...
  const orderr = _orderr(sequelize, DataTypes);
  ...
  food.belongsToMany(user, { as: 'user_id_user_orderrs', through: orderr, foreignKey: "food_id", otherKey: "user_id" });
  ...
  user.belongsToMany(food, { as: 'food_id_foods', through: orderr, foreignKey: "user_id", otherKey: "food_id" });
  ...
  orderr.belongsTo(user, { as: "user", foreignKey: "user_id"});
  user.hasMany(orderr, { as: "orderrs", foreignKey: "user_id"});
